...
import com.example.voip.voip.presenter.call.activities.CallControlButton
            ...
            Box(
                ...
                Column(
                    ...
                    Row(
                        ...
                        CallControlButton(
                            icon = Icons.Rounded.DoorFront, // ou utilisez un custom icon
                            backgroundColor = Color(0xFF4CAF50), // Vert
                            onClick = { onOpenDoor.invoke() },
                        )
